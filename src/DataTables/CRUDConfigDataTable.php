...
class CRUDConfigDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\CRUDConfig $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(CRUDConfig $model)
    {
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->parameters([
                'dom'       => '<"cRUDConfig-toolbar">Bfrtip',
                'order'     => [[0, 'desc']],
                'rowCallback' => "function( nRow, aData, iDisplayIndex ) {
                    fnRowCallBack(nRow, aData, iDisplayIndex, cRUDConfigSelectedRows);
                 }",
                'buttons'   => [
                    [
                       'extend' => 'export',
    ...
    {
        return 'c_r_u_d_configs_datatable_' . time();
    }
}
