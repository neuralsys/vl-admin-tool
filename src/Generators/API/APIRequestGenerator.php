...
namespace Vuongdq\VLAdminTool\Generators\API;
...
class APIRequestGenerator extends BaseGenerator
{
    ...
    {
        $templateData = get_template('api.request.create_request', 'vl-admin-tool');
    ...
    private function generateUpdateRequest()
    {
        ...
        $templateData = get_template('api.request.update_request', 'vl-admin-tool');
