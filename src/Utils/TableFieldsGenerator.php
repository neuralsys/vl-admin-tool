...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName, $ignoredFields, $connection = '')
    {
        ...
        $mappings = config('admin_generator.laravel_generator.from_table.doctrine_mappings', []);
        ...
        $this->defaultSearchable = config('admin_generator.laravel_generator.options.tables_searchable_default', false);
    }
